...
<!-- SIDEBAR -->
    ...
    document.getElementById("remainingTime").innerHTML =  time+" : "+sec;
       ...
       //it calls fuction-timerFuncion after specific time again and again (here 1000ms i.e. 1sec)                 
...
function timerFunction(){
  ...
  //timerfunction will continue till clearInterval function is called.
  
 
  if (time < 0) {
	  //if time is zero display zero and submit the paper using submit
    clearInterval(x);
